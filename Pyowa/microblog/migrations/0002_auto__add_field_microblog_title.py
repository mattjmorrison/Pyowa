...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Microblog.title'
        db.add_column('microblog_microblog', 'title', self.gf('django.db.models.fields.CharField')(default=' ', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Microblog.title'
        db.delete_column('microblog_microblog', 'title')
