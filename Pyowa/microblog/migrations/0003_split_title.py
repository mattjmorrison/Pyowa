...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for microblog in orm.Microblog.objects.all():
            match = re.match(r'(?P<title>.+?):(?P<message>.+)', microblog.message)
            microblog.title = match.group('title')
            microblog.message = match.group('message')
            microblog.save()


    def backwards(self, orm):
        for microblog in orm.Microblog.objects.all():
            microblog.message = microblog.title + ":" + microblog.message
            microblog.save()
